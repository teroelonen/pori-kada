          ...
          <?php foreach ($cookie_categories as $key => $category) { ?>
            <div class="eu-cookie-compliance-category">
              <div>
                ...
                <label for="cookie-category-<?php print drupal_html_class($key); ?>"><?php print t(check_plain($category['label'])); ?></label>
              </div>
            <?php if (isset($category['description'])) : ?>
              <div class="eu-cookie-compliance-category-description"><?php print t(check_plain($category['description'])) ?></div>
            <?php endif; ?>
          </div>
          <?php } //end for ?>
